...
const requiredPublishedFiles = [
  ...
  "evidence/local/2026-07-31-v0.1.33/artifacts/RETENTION.md",
  "evidence/local/2026-07-31-v0.1.33/artifacts/agentnet-0.1.33-py3-none-any.whl",
  "evidence/local/2026-07-31-v0.1.33/artifacts/agentnet-0.1.33.tar.gz",
  "skills/**/*.md",
  "skills/**/*.json",
  "tests/fixtures/**/*.json",
];
...
for (const required of [
  ...
  "Version 0.1.33 has no package-owned in-place broker-credential or database-password rotation transition",
