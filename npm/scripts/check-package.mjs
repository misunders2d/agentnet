...
for (const relative of [
  ...
  "src/agentnet/cli/__init__.py",
  "src/agentnet/cli/main.py",
  "src/agentnet/cli/parser.py",
...
for (const required of [
  ...
  "Version 0.1.39 has no package-owned in-place broker-credential or database-password rotation transition",
  ...
  "after C0, the complete canonical",
  "every named PostgreSQL audit record must prove all",
  "Missing, stale, edited, noncanonical, unaudited, actor/key-drifted, or",
