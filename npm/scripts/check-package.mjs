...
const requiredPublishedFiles = [
  ...
  "evidence/local/2026-08-01-v0.1.36/artifacts/RETENTION.md",
  "evidence/local/2026-08-01-v0.1.36/artifacts/agentnet-0.1.36-py3-none-any.whl",
  "evidence/local/2026-08-01-v0.1.36/artifacts/agentnet-0.1.36.tar.gz",
  "skills/**/*.md",
  "skills/**/*.json",
  "tests/fixtures/**/*.json",
];
...
for (const required of [
  ...
  "Version 0.1.36 has no package-owned in-place broker-credential or database-password rotation transition",
  "server-agent reauthorize-expired-credential",
  "A2A, relay, or retained C0-terminal state requires separate recovery and is refused",
