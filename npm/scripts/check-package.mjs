...
const requiredPublishedFiles = [
  ...
  "evidence/local/2026-08-02-v0.1.37/artifacts/RETENTION.md",
  "evidence/local/2026-08-02-v0.1.37/artifacts/agentnet-0.1.37-py3-none-any.whl",
  "evidence/local/2026-08-02-v0.1.37/artifacts/agentnet-0.1.37.tar.gz",
  "skills/**/*.md",
  "skills/**/*.json",
  "tests/fixtures/**/*.json",
];
...
for (const required of [
  ...
  "Version 0.1.37 has no package-owned in-place broker-credential or database-password rotation transition",
