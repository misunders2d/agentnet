...
For the exact 0.1.37 pre-C0 communication-only case where the retained managed
...
evidence. Published `0.1.18` does not qualify. In 0.1.37, ordinary-server setup
