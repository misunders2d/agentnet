...
| Human authentication and independent approval | Maintained OIDC, PKCE, WebAuthn, and approval-service libraries; exact products not yet selected | **Defer feature activation; reuse required** | Opaque domain principal mapping, exact transaction, independent boundary, recovery, and approval consumption remain corporate | PD-001/002/004 and qualifying independent-boundary topology are unresolved. No custom OIDC/WebAuthn cryptography or same-machine approval shortcut is allowed. |
