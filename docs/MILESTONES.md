...
local only. An optional response schema is stored and digest-bound with the
request and validated before terminal closure. Multi-recipient `any`/`all`/quorum satisfaction rules and
