...
from agentnet.storage.admin_console_schema import (
    ADMIN_CONSOLE_SCHEMA,
    ADMIN_CONSOLE_SCHEMA_VERSION,
)
from agentnet.storage.communication_scope_schema import (
...
SCHEMA_V6 = SCHEMA_V5 + COMMUNICATION_SCOPE_TABLE_DDL
SCHEMA = SCHEMA_V6 + ADMIN_CONSOLE_SCHEMA
_SQLITE_MIGRATION_SQL = {
    ...
    COMMUNICATION_SCOPE_SCHEMA_VERSION: COMMUNICATION_SCOPE_TABLE_DDL,
    ADMIN_CONSOLE_SCHEMA_VERSION: ADMIN_CONSOLE_SCHEMA,
}
...
def _expected_schema_catalog(
    ...
    schemas = {
        ...
        ADMIN_CONSOLE_SCHEMA_VERSION: SCHEMA,
    }
